...
func (t *mixCompactionTask) merge(
	...
	serWriteStart := time.Now()
	sPath, err := statSerializeWrite(ctx, writer, remainingRowCount, t.Allocator, t.binlogIO)
	if err != nil {
...
func (t *mixCompactionTask) Compact() (*datapb.CompactionPlanResult, error) {
	...
	if isSorted {
		compactToSeg, err = mergeSortMultipleSegments(ctxTimeout, t.GetPlanID(), t.binlogIO, t.Allocator, t.plan.GetSegmentBinlogs(), deltaPk2Ts, writer, t.tr, t.currentTs, t.plan.GetCollectionTtl())
		if err != nil {
